...
export const api = {
  ...
  createEstablishmentWithPhoto(formData: FormData) {
    return request<ApiMessageResponse & { id?: number | null; imageUrl?: string; imageUrls?: string[]; imagePaths?: string[] }>('/establishments', {
      method: 'POST',
      body: formData,
  ...
  updateEstablishmentWithPhoto(id: ApiId, formData: FormData) {
    return request<ApiMessageResponse & { imageUrl?: string; imageUrls?: string[]; imagePaths?: string[] }>(`/establishments/${id}`, {
      method: 'PUT',
      body: formData,
